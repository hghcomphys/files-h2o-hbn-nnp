...
from adaptor_RuNNer import KCALMOL_TO_HARTREE, ANGSTROM_TO_BOHR, EV_TO_HARTREE
...
data = RuNNerAdaptorForLAMMPS().read_lammps(lammps_filename, {'1': 'H', '2': 'B', '3': 'N', '4': 'O'}, uc)
