...
from adaptor_RuNNer import UnitConversion, RuNNerAdaptorForVASP
from adaptor_RuNNer import EV_TO_HARTREE, ANGSTROM_TO_BOHR
...
uc = UnitConversion(energy_conversion=EV_TO_HARTREE, length_conversion=ANGSTROM_TO_BOHR)
RuNNerAdaptorForVASP().read_runner(filename).write_poscar(symbol_list=['H', 'B', 'N', 'O'], uc=uc.inverse, number_of_strucure=nsamples, seed=1234)
